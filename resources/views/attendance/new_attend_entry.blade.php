@if($attend_sts->status == 'present')
    ...
    <span class="sub-menu">
        <form action="{{url('new_attend_entry').'/'.$attend_sts->attendance_id.'/'.$attend_sts->period_id}}" method="post" onsubmit="changeAttendace(this); return  false;">
            {{csrf_field()}}
...
@elseif($attend_sts->status == 'absent')
    ...
    <span class="sub-menu">
        <form action="{{url('new_attend_entry').'/'.$attend_sts->attendance_id.'/'.$attend_sts->period_id}}" onsubmit="changeAttendace(this); return  false;" method="post">
            {{csrf_field()}}
