        ...
        <div class="content" style="margin-top:50px;">
            ...
            <table class="table table-bordered">
                ...
                <tr class="table_bordered">
                    ...
                    <th width="110px">{{__('language.Nationality')}}</th>
                    <th width="200px">{{__('language.student_name')}}</th>
                    {{--<th class="d-none d-sm-table-cell" style="width: 30%;">Name (Japanese)</th>--}}
                    <th width="50px">{{__('language.student_gender')}}</th>
                    <th width="100px">{{__('language.student_dob')}}</th>
                    <th width="100px">{{__('language.Entry_Date')}}</th>
                    <th width="70px">{{__('language.student_Status')}}</th>
                    <th width="70px">{{__('language.Card_Period')}}</th>
                    <th width="100px">{{__('language.Card_Expire')}}</th>
                    <th width="160px">{{__('language.student_remarks')}}</th>
                </tr>
                </thead>
