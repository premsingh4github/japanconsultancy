                                                ...
                                                <div class="dropdown d-inline-block ml-2">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-left p-0 border-0 font-size-sm" aria-labelledby="page-header-user-dropdown">
                                                        <div class="p-2">
                                                            ...
                                                            <a class="dropdown-item d-flex align-items-center justify-content-between" onclick="window.open('{{url('admin/student_invoice/'.$students->id)}}', 'popup', 'height=1122,width=994,scrollbars=yes,resize=no,status=no,left=100,top=100');">
                                                                <span>Invoice</span> <i class="fa fa-eye"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
