                ...
                <div class="col-lg-12">
                    <div class="block block-mode-loading-oneui">
                        <div class="block-header border-bottom">
                            ...
                            <div class="row">
                                    <div class="col-sm-5">
                                        <input type="text" name="student_number" @if(request('student_number')) value="{{request('student_number')}}" @endif  class="form-control" placeholder="Enter Student Number">
                                    </div>
                                    <div class="col-sm-4">
                                ...
                                <tbody>
                                    <tr>
                                        <th colspan="11" style="text-align: center;">
                                            <a href="#" class="btn btn-danger btn-sm">Record Not Found</a>
                                        </th>
                                    </tr>
                                {{--<tr>--}}
                                    {{--<th colspan="11">--}}
