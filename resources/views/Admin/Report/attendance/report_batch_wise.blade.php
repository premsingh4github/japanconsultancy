                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text"  name="to_date" class="js-datepicker form-control" value="@if(request('to_date')){{request('to_date')}} @else {{$end_date}} @endif" placeholder="To Date" required>
                                </div>
                            </div>
                        </div>
